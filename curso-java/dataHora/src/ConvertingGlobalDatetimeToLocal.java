...
public class ConvertingGlobalDatetimeToLocal {
	...
	public static void main(String[] args) {
		...
		LocalDateTime r4 = LocalDateTime.ofInstant(d06, ZoneId.of("Portugal")); // fuso de portugal, extraido do objeto ZoneId
		...
		System.out.println("d04 dia = " + d04.getDayOfMonth()); //pegando apenas o dia do objeto d04
